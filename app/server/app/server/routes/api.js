    ...
    getFiles(
      ...
      (data) => {
        return {
          ...
          useFields: data[6],
          glossary: data[7],
          characteristicGroupMappings: data[8],
          cyanMetadata: data[9],
          extremeWeather: data[10],
          upperContent: data[11],
          usgsStaParameters: data[12],
          layerProps: data[13],
          services: data[14],
          NARS: data[15],
          notifications: data[16],
          documentOrder: data[17],
          reportStatusMapping: data[18],
          stateNationalUses: data[19],
          surveyMapping: data[20],
          waterTypeOptions: data[21],
          attainsTribeMapping: data[22],
          wqxTribeMapping: data[23],
        };
      },
    );
  });
