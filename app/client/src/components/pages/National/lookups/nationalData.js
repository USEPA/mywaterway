export default {
  riversAndStreams: {
    overallHealth: {
      ...
      content: `<p>Biological condition tells us how healthy a waterbody is.
      ...
      gives us an idea of how healthy or impaired waters are.</p>`,
    },

    nutrients: {
      percent: '46%',
      title: `of our rivers and streams have
